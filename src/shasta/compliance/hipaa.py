...
HIPAA_CONTROLS: dict[str, HIPAAControl] = {
    ...
    "164.308(b)(1)": HIPAAControl(
        ...
        safeguard=HIPAASafeguard.ADMINISTRATIVE,
        requires_policy=True,
        guidance="Maintain signed BAAs with all vendors that access, store, or transmit ePHI. AWS and Azure both offer BAAs — ensure yours is signed. Track BAA status in your vendor inventory.",
        soc2_equivalent=["CC9.1"],
    ...
    "164.310(a)(1)": HIPAAControl(
        ...
        requires_policy=True,
        guidance="For cloud-native organizations, AWS/Azure data centers handle physical facility security. Document that your infrastructure is cloud-hosted and reference the cloud provider's SOC 2 report for physical controls.",
    ...
    "164.312(a)(2)(iii)": HIPAAControl(
        ...
        safeguard=HIPAASafeguard.TECHNICAL,
        requires_policy=True,
        guidance="Configure session timeouts for all systems accessing ePHI. AWS console sessions should timeout after 1 hour max. Application sessions should timeout after 15 minutes of inactivity.",
        soc2_equivalent=["CC6.1"],
